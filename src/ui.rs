                    ...
                    for r in 0..rows {
                        ...
                        for c in 0..columns {
                            ...
                            let pane_title = if pane.active {
                                Span::styled(format!(" pane {} ", pane.title), Style::default().fg(Color::Yellow).add_modifier(Modifier::BOLD))
                            } else {
                                Span::styled(format!(" pane {} ", pane.title), Style::default().fg(Color::DarkGray))
                            };
